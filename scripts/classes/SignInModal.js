...
class SignInModal extends Modal {
  ...
  createElements() {
    ...
    this.signInForm.insertAdjacentHTML(
      'beforeend',
      `<h1 class="h3 mb-3">Please sign in</h1><p class="text-info">please use any credentials, real sign in functionality is disabled for testing purposes</p>
    `
    );
